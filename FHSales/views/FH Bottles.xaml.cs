...
{
    /// <summary>
    /// Interaction logic for FH_Bottles.xaml
    /// </summary>
    public partial class FH_Bottles : UserControl
    {
        public FH_Bottles()
        {
            InitializeComponent();
        ...
        private List<DirectSalesModel> loadDataGridDetailsDirectSales()
        {
            ...
            string queryString = "SELECT dbfh.tbldirectsales.ID, clientname, quantity, cashbankID, bankname, courierID, " +
                ...
                "dbfh.tbldirectsales.courierID = dbfh.tblcourier.ID) WHERE dbfh.tbldirectsales.salestypeID = 2 AND dbfh.tbldirectsales.isDeleted = 0 ORDER BY deliverydate DESC";
        ...
        {
            FHBottles_Report bottlesRep = new FHBottles_Report();
            bottlesRep.ShowDialog();
        }
