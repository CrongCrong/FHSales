...
{
    /// <summary>
    /// Interaction logic for FHGuava_Report.xaml
    /// </summary>
    public partial class FHGuava_Report : MetroWindow
    {
        public FHGuava_Report()
        {
            InitializeComponent();
        }
        ConnectionDB conDB;
        ...
        private void btnGenerate_Click(object sender, RoutedEventArgs e)
        {
            if (cmbCashBank.SelectedItem != null && cmbReportDate.SelectedItem != null)
            {
                ...
                if (repDate.DateReport.Equals("BY MONTH"))
                {
                    ...
                    ReportForm report = new ReportForm(bnk, repDate, "FHGUAVA");
                    report.ShowDialog();
                }
                else
                {
